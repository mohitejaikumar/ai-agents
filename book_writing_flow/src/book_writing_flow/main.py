...
from crews.chapter_writing_crew.chapter_writing_crew import ChapterWritingCrew
from crews.outline_crew.outline_writing_crew import OutlineWritingCrew
...
class BookFlow(Flow[BookState]):
    ...
    def generate_outline(self):
        ...
        outline = OutlineWritingCrew().crew().kickoff(inputs={"topic": self.state.topic})
        print("DEBUG: Outline output:", outline)
